module.exports = {
    ...
    "rules": {
        ...
        "getter-return": "warn", // 强制 getter 函数中出现 return 语句
        ...
        'no-trailing-spaces': "warn", // Fix 禁用行尾空格
        ...
        'object-property-newline': "off", // Fix 强制将对象的属性放在不同的行上
        ...
        'space-before-blocks': 'warn', // Fix 强制在块之前使用一致的空格
